    ...
    public String getSummary(AbstractBuild<?, ?> target) {
        try {
            ...
            if (target.getResult().isCompleteBuild()) {
                ...
                return "<td class=\"wrench\" style=\"background-color: #ffff00;\">R</td><td class=\"wrench\" style=\"background-color: #ffff00;\">U</td><td class=\"wrench\" style=\"background-color: #ffff00;\">N</td><td class=\"wrench\" style=\"background-color: #ffff00;\">N</td><td class=\"wrench\" style=\"background-color: #ffff00;\">I</td><td class=\"wrench\" style=\"background-color: #ffff00;\">N</td><td class=\"wrench\" style=\"background-color: #ffff00;\">G</td>";
            }
        }
    }
